...
library ReserveLogic {
   ...
   * @param reserve The reserve object
   * @param wvTokenAddress The address of the overlying atoken contract
  ...
  function updateInterestRates(
    ...
    vars.debtTokenAddress = reserve.debtTokenAddress;
  ...
  function _mintToTreasury(
    ...
    if (vars.amountToMint != 0) {
      IWvToken(reserve.wvTokenAddress).mintToTreasury(vars.amountToMint, newLiquidityIndex);
    }
  }
