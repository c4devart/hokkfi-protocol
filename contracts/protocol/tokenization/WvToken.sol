...
import {VersionedInitializable} from '../libraries/hokkfi-upgradeability/VersionedInitializable.sol';
import {IncentivizedERC20} from './IncentivizedERC20.sol';
// import {IHokkfiIncentivesController} from '../../interfaces/IHokkfiIncentivesController.sol';
import "hardhat/console.sol";

/**
 * @title Hokkfi ERC20 WvToken
 * @dev Implementation of the interest bearing token for the Hokkfi protocol
 */
  ...
  IWvToken
{
  ...
  // IHokkfiIncentivesController internal _incentivesController;
   ...
   * @param treasury The address of the hokkfi treasury, receiving the fees on this wvToken
  ...
  function initialize(
    ...
    // IHokkfiIncentivesController incentivesController,
  ...
  /**
   * @dev Returns the address of the hokkfi treasury, receiving the fees on this wvToken
   **/
   ...
   **/
  /* function _getIncentivesController() internal view override returns (IHokkfiIncentivesController) {
   ...
   **/
  /* function getIncentivesController() external view override returns (IHokkfiIncentivesController) {
